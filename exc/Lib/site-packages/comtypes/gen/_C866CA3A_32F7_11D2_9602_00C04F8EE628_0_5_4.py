...
__all__ = [
    ...
    'ISpeechBaseStream', 'SPRS_ACTIVE', 'SPRECOGNIZERSTATUS',
    'SREPropertyStringChange', 'SPBO_AHEAD', 'DISPID_SRRGetXMLResult',
    'DISPID_SRCERecognitionForOtherContext', 'SpeechInterference',
    'SPAR_Medium', 'DISPID_SRGId', 'ISpeechRecoResultTimes',
    'DISPID_SPIRule', 'SPXMLRESULTOPTIONS', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SVGetAudioOutputs', 'SDKLCurrentUser',
    'SAFTNonStandardFormat', 'SP_VISEME_4', 'SPAUDIOOPTIONS',
    'SPPARTOFSPEECH', 'SPWT_PRONUNCIATION', 'DISPID_SLWsCount',
    'SAFT12kHz8BitMono', 'SVP_8', 'SPSTREAMFORMATTYPE', 'SP_VISEME_1',
    'eLEXTYPE_RESERVED8', 'DISPID_SRRAudioFormat',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SBSSeek',
    'SVSFPurgeBeforeSpeak', 'DISPID_SVSpeakStream',
    'ISpeechLexiconWords', 'SPPS_RESERVED3',
    ...
    'DISPID_SOTIsUISupported', 'SPWAVEFORMATTYPE',
    'DISPID_SRRRecoContext', 'SVP_13', 'SGSDisabled',
    'SpeechVoiceCategoryTTSRate', 'ISpDataKey', 'DISPID_SGRsCommit',
    'DISPID_SRSSupportedLanguages', 'SVP_1',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SDKSetBinaryValue',
    'DISPID_SABufferNotifySize', 'DISPID_SRAudioInputStream',
    'SPEVENT', '_ISpeechRecoContextEvents', 'DISPID_SPCIdToPhone',
    'DISPID_SGRsItem', 'SPVPRI_OVER', 'SPEI_HYPOTHESIS',
    'DISPID_SPRText', 'DISPID_SWFEExtraData', 'tagSPPROPERTYINFO',
    'SVF_Emphasis', 'DISPID_SOTSetId', 'SPAO_NONE', 'SECFIgnoreCase',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SPIStartTime', 'ISpeechLexiconPronunciations',
    'WAVEFORMATEX', 'SPEI_PHONEME', 'SRSEIsSpeaking', 'ISpeechAudio',
    ...
    'DISPID_SPIAudioStreamPosition', 'SpMMAudioEnum',
    'SPPS_RESERVED2', 'DISPID_SRRSaveToMemory',
    'DISPID_SPIProperties', 'DISPID_SPEAudioSizeTime',
    'SDA_One_Trailing_Space', 'DISPID_SVSPhonemeId',
    'STSF_FlagCreate', 'SpeechVisemeFeature', 'ISpeechLexiconWord',
    'SPEI_TTS_BOOKMARK', 'SpeechRuleAttributes',
    'DISPID_SVSLastBookmark', 'DISPID_SMSSetData', 'SVP_10',
    'SPPHRASEPROPERTY', '_ISpeechVoiceEvents', 'SVEAudioLevel',
    'DISPID_SpeechRecoContext', 'SPSFunction', 'DISPID_SLWLangId',
    'ISpPhoneConverter', 'DISPID_SPIAudioSizeTime', 'SVPAlert',
    'SWTDeleted', 'DISPID_SGRSTsCount', 'DISPID_SRProfile',
    'DISPID_SRCEEnginePrivate', 'SPEI_MAX_TTS',
    'SpeechPropertyComplexResponseSpeed', 'SPRULE',
    'SpeechTokenValueCLSID', 'DISPID_SOTGetAttribute',
    'SPPS_Modifier', 'SVP_19', 'ISpeechRecoGrammar', 'SP_VISEME_20',
    'SPLO_STATIC', 'SPXRO_Alternates_SML', 'SVSFParseSsml',
    'DISPID_SPIEnginePrivateData', 'DISPID_SRGRules', 'SREPrivate',
    'SPEI_RESERVED6', 'DISPID_SpeechPhraseInfo',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SpeechAudioStatus',
    'DISPID_SpeechPhraseRules',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'ISpEventSink',
    'ISpRecoResult', 'DISPID_SPCPhoneToId', 'eLEXTYPE_PRIVATE4',
    'ISpeechPhraseReplacements', 'SP_VISEME_19', 'SPLO_DYNAMIC',
    'DISPID_SPRs_NewEnum', 'DISPID_SRGCommit', 'IEnumString',
    'SPEI_INTERFERENCE', 'SDTDisplayText', 'SVP_20',
    'DISPID_SVSLastBookmarkId', 'SPRECOSTATE', 'DISPID_SVGetProfiles',
    'SPAO_RETAIN_AUDIO', 'SAFTADPCM_11kHzStereo', 'SECFEmulateResult',
    'SAFT11kHz8BitMono', 'DISPID_SPARecoResult',
    'DISPID_SVEStreamStart', 'SpeechGrammarTagWildcard',
    'SpeechVoicePriority', 'DISPID_SPACommit', 'SpInProcRecoContext',
    'SRTExtendableParse', 'SPEI_MIN_TTS', 'SREPhraseStart',
    'DISPID_SLWs_NewEnum', 'SLTUser',
    'DISPID_SVSInputSentencePosition', 'SDTAll', 'SINoise',
    'SPRST_INACTIVE', 'DISPID_SVVolume', 'SPPS_NotOverriden',
    'SAFT11kHz8BitStereo', 'ISpeechGrammarRuleStateTransitions',
    'SPWORDLIST', 'DISPID_SOTCDefault', 'ISpeechGrammarRuleState',
    'SPGS_DISABLED', 'DISPID_SRGCmdLoadFromFile', 'SAFT16kHz8BitMono',
    'DISPID_SVSyncronousSpeakTimeout', 'eWORDTYPE_ADDED',
    'DISPID_SpeechObjectToken', 'SPPS_LMA', 'ISpRecognizer2',
    'SPPS_Unknown', 'ISpStreamFormatConverter',
    'DISPID_SGRSTPropertyId', 'DISPID_SPRules_NewEnum',
    'DISPID_SVRate', 'SDTProperty', 'DISPID_SRRPhraseInfo',
    'DISPID_SLWsItem', 'SPFM_OPEN_READWRITE',
    'DISPID_SPRuleEngineConfidence', 'SPEI_VOICE_CHANGE',
    'DISPID_SABIBufferSize', 'SECFDefault', 'SPSHORTCUTPAIRLIST',
    'ISpeechPhraseElement', 'ISpStream', 'SPEI_RECO_OTHER_CONTEXT',
    'SPTEXTSELECTIONINFO', 'SPGRAMMARWORDTYPE',
    'SpeechRecognitionType', 'SVSFDefault',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'ISpeechPhraseElements',
    'DISPID_SOTs_NewEnum', 'SpeechRetainedAudioOptions',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SPPs_NewEnum',
    ...
    'DISPID_SBSWrite', 'SDA_Two_Trailing_Spaces',
    'SpeechCategoryAudioOut', 'SRATopLevel', 'DISPID_SVEPhoneme',
    'SPPS_Function', 'eLEXTYPE_PRIVATE20', 'DISPID_SRCEPhraseStart',
    'ISpeechPhraseProperties', 'ISpeechFileStream',
    'DISPID_SDKGetStringValue', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SRCVoice', 'SAFTADPCM_44kHzStereo',
    'DISPID_SRGetRecognizers', 'ISpProperties',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SASNonBlockingIO', 'SpeechRegistryLocalMachineRoot',
    'SpeechAllElements', 'DISPID_SRCEStartStream',
    'DISPID_SPEPronunciation', 'DISPID_SRGCmdLoadFromMemory',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SPIElements',
    'SAFTADPCM_8kHzStereo', 'SAFT12kHz8BitStereo', 'SPEI_SR_BOOKMARK',
    'SPEI_RESERVED1', 'eLEXTYPE_LETTERTOSOUND', 'SRARoot',
    'SGRSTTRule', 'SpeechTokenIdUserLexicon', 'DISPID_SVSpeak',
    'SPWORD', 'SPFILEMODE', 'SP_VISEME_17', 'SPFM_OPEN_READONLY',
    'SGSExclusive', '_SPAUDIOSTATE', 'SpeechTokenContext',
    'SAFT24kHz16BitMono', 'SpeechEngineProperties',
    'IInternetSecurityManager', 'DISPID_SRCEFalseRecognition',
    'DISPID_SpeechFileStream', 'DISPID_SOTsCount',
    'DISPID_SpeechPhraseProperties', 'DISPID_SRCRetainedAudio',
    'SPINTERFERENCE', '__MIDL_IWinTypes_0009', 'SAFT11kHz16BitMono',
    'DISPID_SVEStreamEnd', 'SPDKL_DefaultLocation', 'SPXRO_SML',
    'DISPID_SRGIsPronounceable', 'DISPID_SPRuleChildren',
    'SpeechRecoProfileProperties', 'eLEXTYPE_PRIVATE18',
    'DISPID_SVEAudioLevel', 'DISPID_SGRSRule', 'eLEXTYPE_USER',
    ...
    'SSTTDictation', 'DISPID_SVAudioOutput',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SRRTStreamTime',
    'DISPID_SVStatus', 'SPPS_Interjection', 'SRTAutopause',
    'SPPHRASERULE', 'SPCONTEXTSTATE', 'DISPID_SpeechLexiconWord',
    'SPWORDPRONUNCIATION', 'SAFT32kHz16BitStereo', 'SPVPRI_ALERT',
    'DISPID_SVSInputWordLength', 'SRERecognition',
    'SAFTCCITT_ALaw_8kHzStereo', 'SVP_4', 'DISPID_SRCERequestUI',
    'SpTextSelectionInformation', 'SVEStartInputStream',
    'SP_VISEME_10', 'SpSharedRecognizer', 'SAFTCCITT_ALaw_22kHzMono',
    'ISpeechObjectToken', 'SREAdaptation', 'SPWT_LEXICAL',
    'SPSInterjection', 'SRSActiveAlways', 'SpeechRunState',
    'SITooLoud', 'SREStreamStart', 'eLEXTYPE_PRIVATE14',
    'DISPID_SGRSTsItem', 'SPCT_DICTATION', 'ISpEventSource',
    'SVSFIsXML', 'SPFM_CREATE', 'DISPID_SpeechVoiceEvent',
    'DISPID_SOTId', 'SVPNormal', 'SPPS_Noncontent', 'SVF_None',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SVSFIsFilename',
    'SPEI_PROPERTY_NUM_CHANGE', 'SRAInterpreter',
    'ISpObjectTokenCategory', 'DISPID_SPEAudioTimeOffset',
    'SAFT22kHz16BitMono', 'DISPID_SOTCSetId',
    'SAFTTrueSpeech_8kHz1BitMono', 'SLODynamic', 'SP_VISEME_0',
    'Speech_Max_Word_Length', 'ISpPhrase', 'DISPID_SPPValue',
    'SPAR_Unknown', 'SRCS_Disabled', 'SpeechPropertyResourceUsage',
    'SPSEMANTICERRORINFO', 'eWORDTYPE_DELETED', 'eLEXTYPE_PRIVATE8',
    'SpNullPhoneConverter', 'SRSInactive', 'DISPID_SGRClear',
    'DISPID_SPILanguageId', 'tagSTATSTG', 'eLEXTYPE_PRIVATE3',
    'SVSFIsNotXML', 'SECFIgnoreWidth', 'SPSUnknown',
    'DISPID_SGRInitialState', 'SPAS_RUN', 'DISPID_SpeechMMSysAudio',
    'SECNormalConfidence', 'eLEXTYPE_RESERVED4', 'SFTSREngine',
    'DISPID_SVGetVoices', 'SpWaveFormatEx',
    'DISPID_SRCERecognizerStateChange', 'SPRULESTATE',
    'SPRS_ACTIVE_USER_DELIMITED', 'ISpeechRecoResult',
    'DISPID_SDKGetlongValue', 'SRTStandard', 'ISpeechMMSysAudio',
    'DISPID_SRDisplayUI', 'SAFTCCITT_uLaw_22kHzMono',
    'SpeechFormatType', 'SP_VISEME_21',
    'DISPID_SVSCurrentStreamNumber', 'SLTApp', 'SAFTDefault',
    'DISPID_SRCResume', 'DISPID_SGRsCount', 'SpeechTokenKeyUI',
    'SVPOver', 'DISPID_SRSetPropertyNumber',
    'DISPID_SOTGetDescription', 'ISpLexicon', 'ISpStreamFormat',
    'SpeechTokenKeyAttributes', 'SPDKL_LocalMachine', 'SVP_3',
    'SPWORDPRONOUNCEABLE', 'SGRSTTWord', 'DISPID_SVAlertBoundary',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPEI_SENTENCE_BOUNDARY',
    'SECFNoSpecialChars', 'SVSFVoiceMask',
    'DISPID_SLGetGenerationChange', 'DISPID_SRGetPropertyNumber',
    'DISPID_SGRsFindRule', 'DISPID_SWFESamplesPerSec',
    'ISpeechPhraseProperty', 'SRADynamic', 'SECLowConfidence',
    'DISPID_SPRuleName', 'SAFTCCITT_uLaw_11kHzMono', 'SPSVerb',
    'SPBINARYGRAMMAR', 'DISPID_SWFEChannels', 'SGDSActive',
    'SREHypothesis', 'SPCT_SLEEP', 'SPPHRASE', 'SRADefaultToActive',
    'SREAllEvents', 'STCLocalServer', 'DISPID_SPEDisplayAttributes',
    'SREPropertyNumChange', 'DISPID_SLAddPronunciation',
    'SpInprocRecognizer', 'DISPID_SRSetPropertyString', 'SGDisplay',
    'SP_VISEME_13', 'DISPID_SVSkip', 'SAFT22kHz16BitStereo',
    'SDTAudio', 'SpLexicon', 'SDTReplacement', 'SAFTADPCM_11kHzMono',
    'SPCT_SUB_DICTATION', 'SAFT16kHz16BitMono', 'SPVISEMES',
    'DISPID_SPPParent', 'DISPID_SPEActualConfidence',
    'DISPID_SGRSTPropertyValue', 'ISpRecoContext', 'DISPID_SRStatus',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SGRsAdd',
    'DISPID_SOTMatchesAttributes', 'DISPID_SDKEnumKeys',
    'DISPID_SGRSTText', 'DISPID_SVEventInterests',
    'SAFT44kHz8BitMono', 'SLOStatic',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SPPName',
    'SPVOICESTATUS', 'SpPhoneConverter', 'SVSFlagsAsync',
    'STCInprocServer', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SRGReset', 'SAFT32kHz16BitMono', 'DISPID_SPIGetText',
    'SPRECOCONTEXTSTATUS', 'ISpeechVoiceStatus',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SLGetWords', 'DISPID_SPCLangId',
    'DISPID_SRGetFormat', 'Speech_StreamPos_RealTime',
    'SGRSTTTextBuffer', 'ISpeechObjectTokens', 'SAFT44kHz16BitStereo',
    'DISPID_SDKSetLongValue', 'SDTAlternates', 'SpeechAudioVolume',
    'SAFTADPCM_44kHzMono', 'eLEXTYPE_PRIVATE1', 'SAFTADPCM_8kHzMono',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'eLEXTYPE_PRIVATE15',
    'SpeechAudioFormatGUIDWave', 'SPWT_DISPLAY', 'eLEXTYPE_RESERVED7',
    'SPLEXICONTYPE', 'DISPID_SPAs_NewEnum', 'SVEAllEvents',
    'SpeechDictationTopicSpelling', 'eLEXTYPE_PRIVATE17',
    'SPEVENTENUM', 'SPAS_PAUSE', 'DISPID_SPRuleParent',
    'SPCT_COMMAND', 'DISPID_SPIEngineId', 'DISPID_SRCState',
    'SVSFParseSapi', 'Speech_Default_Weight', 'SPDKL_CurrentConfig',
    'DISPIDSPRG', 'SAFT48kHz16BitMono', 'DISPID_SDKOpenKey',
    'SPINTERFERENCE_TOOLOUD', 'SGRSTTDictation', 'SpeechVoiceEvents',
    'SAFT11kHz16BitStereo', 'SpeechRecoEvents', 'SPCS_ENABLED',
    'ISpGrammarBuilder', 'DISPID_SADefaultFormat', 'IStream',
    'SRSInactiveWithPurge', 'DISPID_SVPriority',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SGRAttributes',
    'SAFT44kHz8BitStereo', 'SVSFUnusedFlags', 'SVP_7',
    'DISPID_SRGCmdLoadFromResource', 'SPINTERFERENCE_TOOFAST',
    'eLEXTYPE_RESERVED9', 'SPBO_TIME_UNITS', 'ISpNotifySink',
    'SpeechRegistryUserRoot', 'SPBO_NONE', 'eLEXTYPE_PRIVATE6',
    'SPAUDIOSTATUS', 'DISPID_SpeechObjectTokens', 'SVEPhoneme',
    'DISPID_SPAsCount', 'DISPID_SMSGetData',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SVEBookmark',
    'SpeechVoiceSpeakFlags', 'DISPID_SLWWord',
    'DISPID_SRGCmdSetRuleState', 'SpeechPropertyAdaptationOn',
    'SpeechWordPronounceable', 'DISPID_SLPPartOfSpeech',
    'SP_VISEME_15', 'SAFTCCITT_ALaw_11kHzMono', 'SRTEmulated',
    'SAFTADPCM_22kHzStereo', 'DISPID_SVEVoiceChange',
    'ISpeechRecognizerStatus', 'SGDSInactive', 'SPBOOKMARKOPTIONS',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SPPsCount',
    'DISPID_SRGSetTextSelection',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SGRSTNextState', 'ISpeechCustomStream', 'SPAS_CLOSED',
    'SpeechStreamFileMode', 'SpeechAudioState', 'DISPID_SBSFormat',
    'SFTInput', 'SpeechWordType', 'DISPID_SABIMinNotification',
    'DISPID_SRCBookmark', 'SAFTGSM610_11kHzMono',
    'DISPID_SRCEPropertyNumberChange', 'SpFileStream',
    'DISPID_SDKDeleteValue', 'DISPID_SPPId',
    'SGLexicalNoSpecialChars', 'SPSHORTCUTPAIR', 'ISpeechAudioFormat',
    'SSFMOpenForRead', 'DISPID_SAFGuid', 'SDA_Consume_Leading_Spaces',
    'DISPID_SGRAddResource', 'SPEI_MIN_SR',
    'SPSMF_SRGS_SAPIPROPERTIES', 'ISpRecoCategory',
    'SPEI_TTS_AUDIO_LEVEL', 'SpeechAudioProperties',
    'DISPID_SPRulesItem', 'SAFTText', 'DISPID_SRIsShared',
    'SVSFPersistXML', 'SPINTERFERENCE_NOISE',
    'DISPID_SOTCreateInstance', 'DISPIDSPTSI_ActiveLength',
    'SRAImport', 'SVP_0', 'SASClosed', 'STCInprocHandler',
    'SVF_Stressed', 'SPSHT_OTHER', 'DISPID_SpeechRecognizer',
    'SPPS_Noun', 'SPEI_RESERVED2', 'SPAUDIOSTATE',
    'DISPID_SRSAudioStatus', 'SAFTCCITT_uLaw_8kHzMono', 'SVP_18',
    'DISPID_SLPType', 'SP_VISEME_7', 'SpeechLexiconType',
    'SpCompressedLexicon', 'DISPID_SLPsCount', 'DISPID_SRRSpeakAudio',
    'SRCS_Enabled', 'DISPID_SRGCmdLoadFromObject',
    'ISpeechPhraseAlternates', 'DISPID_SVDisplayUI',
    'SpeechPropertyHighConfidenceThreshold', 'SPSMF_UPS',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SLPsItem',
    'ISpeechRecognizer', 'tagSPTEXTSELECTIONINFO', 'SDTRule',
    'ISpeechAudioBufferInfo', 'DISPID_SpeechPhraseProperty',
    'SPRST_INACTIVE_WITH_PURGE', 'SPEVENTSOURCEINFO', 'SVP_5',
    'DISPID_SPRulesCount', 'SpeechGrammarWordType',
    'SPEI_FALSE_RECOGNITION', 'SGRSTTWildcard', 'SPGRAMMARSTATE',
    'DISPID_SWFEBlockAlign', 'SP_VISEME_9',
    'DISPID_SOTRemoveStorageFileName', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SLGenerationId', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SPRFirstElement', 'SP_VISEME_16', 'SGRSTTEpsilon',
    'DISPID_SRGetPropertyString', 'SREInterference',
    'SAFTExtendedAudioFormat', 'SAFT44kHz16BitMono',
    'DISPID_SRCSetAdaptationData', 'DISPID_SpeechPhraseReplacement',
    'SAFTGSM610_44kHzMono', 'SVSFParseMask', 'SpeechCategoryVoices',
    'SASRun', 'DISPID_SABufferInfo', 'DISPID_SVVoice',
    'ISpeechPhraseInfo', 'DISPID_SpeechRecoResult',
    'DISPID_SpeechPhoneConverter', 'SpAudioFormat',
    'SPEI_WORD_BOUNDARY', 'SpObjectToken', 'ISpRecognizer3',
    'SPEI_END_INPUT_STREAM', 'SWPUnknownWordUnpronounceable',
    'STSF_CommonAppData', 'SpUnCompressedLexicon',
    'SpeechPartOfSpeech', 'DISPID_SAFType', 'SPAS_STOP',
    'DISPID_SRSClsidEngine', 'SVP_17', 'eLEXTYPE_PRIVATE5',
    'DISPID_SRCEHypothesis', 'DISPID_SPISaveToMemory', 'SP_VISEME_6',
    'DISPID_SRCEAudioLevel', 'SPSHT_Unknown', 'SPSHT_EMAIL',
    'SpeechGrammarState', 'SPWF_SRENGINE',
    'DISPID_SPRDisplayAttributes', 'SAFT32kHz8BitMono',
    'DISPID_SPRuleFirstElement', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SVESentenceBoundary', 'DISPID_SGRAddState', 'ISpShortcut',
    'SVP_21', 'DISPID_SREmulateRecognition', 'SpeechAudioFormatType',
    'DISPID_SLPSymbolic', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SVSVisemeId', 'eLEXTYPE_RESERVED6', 'SASStop',
    'ISpeechXMLRecoResult', 'SPEI_ADAPTATION', 'DISPID_SABIEventBias',
    'DISPID_SRRTimes', 'SAFT22kHz8BitMono', 'DISPID_SRRAlternates',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SAFTGSM610_8kHzMono',
    'DISPID_SRCEBookmark', 'SDA_No_Trailing_Space', 'SP_VISEME_5',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPPS_RESERVED4',
    'ISpeechObjectTokenCategory', 'ISpeechDataKey',
    'DISPID_SRCEInterference', 'DISPID_SLAddPronunciationByPhoneIds',
    'ISpVoice', 'SPEI_SR_RETAINEDAUDIO', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SLPLangId', 'DISPID_SpeechVoice', 'SDTLexicalForm',
    'DISPID_SRCEventInterests', 'ISpNotifyTranslator',
    'SPPS_SuppressWord', 'SPEI_RESERVED5', 'DISPID_SGRsCommitAndSave',
    'SRSActive', 'SPEI_VISEME', 'SPADAPTATIONRELEVANCE',
    'DISPID_SpeechGrammarRule', 'Speech_Max_Pron_Length',
    'SpeechGrammarTagDictation', 'SVEVoiceChange', 'SRAORetainAudio',
    'SPINTERFERENCE_TOOQUIET', 'SPEI_REQUEST_UI',
    'DISPID_SpeechRecoResult2', 'SpPhraseInfoBuilder',
    'DISPID_SVEViseme', 'SVP_11', 'SPEI_TTS_PRIVATE',
    'SECHighConfidence', 'SPLOADOPTIONS', 'SAFT24kHz16BitStereo',
    'SSTTWildcard', 'ISpeechMemoryStream', 'ISpeechGrammarRules',
    'SpeechGrammarTagUnlimitedDictation', 'SPEI_END_SR_STREAM',
    'DISPID_SLPs_NewEnum', 'DISPID_SpeechLexiconPronunciation',
    'SDKLCurrentConfig', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SOTCGetDataKey', 'SPSHORTCUTTYPE', 'DISPID_SPAsItem',
    'DISPID_SRCERecognition', 'SPEI_SOUND_END', 'SPSERIALIZEDPHRASE',
    'ISpXMLRecoResult', 'DISPID_SDKSetStringValue',
    'DISPID_SPIRetainedSizeBytes', 'ISpeechVoice',
    'eLEXTYPE_PRIVATE16', 'SPFM_CREATE_ALWAYS', 'SPCS_DISABLED',
    'DISPID_SOTRemove', 'DISPID_SRCRecognizer',
    'SAFTNoAssignedFormat', 'SpeechCategoryAudioIn',
    'DISPID_SWFEBitsPerSample', 'SpeechUserTraining',
    'DISPID_SMSALineId', 'DISPID_SpeechAudio', 'DISPID_SASetState',
    'SpeechVoiceSkipTypeSentence', 'DISPIDSPTSI',
    'DISPID_SLRemovePronunciation', 'DISPID_SRState', 'SPRST_ACTIVE',
    'ISpSerializeState', 'ISpRecoGrammar2', 'DISPID_SMSADeviceId',
    'SSFMOpenReadWrite', 'STCRemoteServer', 'SP_VISEME_18',
    'ISpObjectToken', 'SPWORDTYPE', 'SPEI_PHRASE_START',
    'DISPID_SVSInputWordPosition', 'ISpeechLexiconPronunciation',
    'SPWF_INPUT', 'DISPID_SMSAMMHandle', 'DISPID_SRCESoundStart',
    'SpeechCategoryPhoneConverters', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SPAStartElementInResult',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SLWPronunciations',
    'SPAR_High', 'SpeechEngineConfidence', 'DISPID_SRGDictationLoad',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SGRSTWeight',
    'DISPID_SDKGetBinaryValue', 'DISPID_SOTGetStorageFileName',
    'SPINTERFERENCE_NONE', 'DISPID_SpeechLexicon', 'SPPS_RESERVED1',
    'ISpeechPhraseRule', 'DISPID_SRCEEndStream',
    'SAFT8kHz16BitStereo', 'DISPID_SRRTOffsetFromStart',
    'eLEXTYPE_PRIVATE12', 'DISPID_SRCESoundEnd', 'SP_VISEME_14',
    'SWPKnownWordPronounceable', 'SWTAdded', 'ISpRecoContext2',
    'SAFTADPCM_22kHzMono', 'DISPID_SPAPhraseInfo',
    'DISPID_SRSNumberOfActiveRules', 'ISpAudio', 'ISpeechAudioStatus',
    'STSF_AppData', 'SP_VISEME_3', 'SPDKL_CurrentUser',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SpeechDataKey',
    'DISPID_SLGetPronunciations', 'SpeechBookmarkOptions',
    'DISPID_SRRecognizer', 'SpeechRuleState', 'eLEXTYPE_PRIVATE11',
    'SAFT48kHz8BitMono', 'DISPID_SPIGrammarId',
    'DISPIDSPTSI_ActiveOffset', 'SPEI_RESERVED3',
    'DISPID_SpeechRecoResultTimes', 'SGDSActiveUserDelimited',
    'SPSHT_NotOverriden', 'SP_VISEME_12', 'SECFIgnoreKanaType',
    'ISpPhoneticAlphabetSelection', 'ISpPhoneticAlphabetConverter',
    'ISpeechResourceLoader', 'SP_VISEME_2', 'eLEXTYPE_PRIVATE13',
    'ISpNotifySource', 'DISPID_SPPsItem', 'SAFT8kHz8BitStereo',
    'ISpeechLexicon', 'SAFT22kHz8BitStereo',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SPEsItem', 'SBOPause',
    'DISPID_SPEDisplayText', 'SDTPronunciation',
    'DISPID_SPPNumberOfElements', 'DISPID_SpeechMemoryStream',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SAFSetWaveFormatEx',
    'SVP_14', 'SRESoundEnd', 'SPCT_SUB_COMMAND',
    'ISpeechTextSelectionInformation', 'ISpRecoGrammar',
    'SRERecoOtherContext', 'DISPID_SpeechPhraseElement', 'SITooFast',
    'SRESoundStart', 'DISPID_SAVolume', 'SRTReSent',
    'DISPID_SRAudioInput', 'DISPID_SPPFirstElement',
    'DISPID_SPELexicalForm', 'SPRS_INACTIVE', 'SPEI_START_SR_STREAM',
    'SPEI_UNDEFINED', 'SVESentenceBoundary',
    'DISPID_SpeechLexiconWords', 'SPEI_RECOGNITION',
    ...
    'DISPID_SGRName', 'SpShortcut', 'SpeechLoadOption',
    ...
    'DISPID_SRGDictationSetState', 'SDKLLocalMachine', 'eLEXTYPE_APP',
    'DISPID_SpeechGrammarRules', 'DISPID_SRIsUISupported',
    'eLEXTYPE_PRIVATE2', 'SVEPrivate', 'SpeechVisemeType',
    'eLEXTYPE_USER_SHORTCUT', 'SAFTGSM610_22kHzMono',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SOTDataKey',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SAFGetWaveFormatEx', 'SAFT32kHz8BitStereo',
    'DISPID_SpeechPhraseElements', 'SREBookmark', 'SPSSuppressWord',
    'SRTSMLTimeout', 'DISPID_SVResume', 'ISpeechGrammarRule',
    'SPRECORESULTTIMES', 'DISPID_SGRSTPropertyName',
    'SPEI_SOUND_START', 'SINoSignal', 'DISPID_SpeechRecognizerStatus',
    'SAFT48kHz8BitStereo', 'SPSModifier', 'SPEI_SR_PRIVATE',
    'SPEI_MAX_SR', 'DISPID_SpeechObjectTokenCategory',
    'SAFT12kHz16BitMono', 'SPSNoun', 'SVP_9', 'LONG_PTR',
    'DISPID_SRCPause', 'DISPID_SpeechAudioBufferInfo',
    'SpCustomStream', '_RemotableHandle', 'SpeechAddRemoveWord',
    'SpeechTokenKeyFiles', 'SPCATEGORYTYPE', 'SASPause', 'SBONone',
    'SPRST_NUM_STATES', 'SpeechStreamSeekPositionType',
    'SAFT24kHz8BitMono', 'DISPID_SPPEngineConfidence',
    'SPPHRASEREPLACEMENT', 'SpeechPropertyResponseSpeed',
    'DISPID_SVGetAudioInputs', 'SAFT8kHz16BitMono',
    'DISPID_SpeechAudioFormat', 'DISPID_SVAudioOutputStream',
    'SVEWordBoundary', 'SVP_12', 'DISPID_SRRAudio',
    'DISPID_SGRsDynamic', 'DISPID_SWFEFormatTag',
    'SpSharedRecoContext', 'SpeechCategoryAppLexicons',
    'DISPID_SOTCategory', 'DISPID_SPERetainedStreamOffset',
    'SPSNotOverriden', 'DISPID_SRRTLength', 'SITooSlow',
    'ISpeechPhoneConverter', 'DISPID_SPRNumberOfElements',
    'ISpeechPhraseRules', 'DISPID_SpeechXMLRecoResult',
    'SPEI_START_INPUT_STREAM', 'ISpeechRecoResult2',
    'DISPID_SPRuleConfidence', 'DISPID_SRCreateRecoContext',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SPPChildren', 'SITooQuiet',
    'SpeechCategoryRecognizers', 'SGDSActiveWithAutoPause',
    'IInternetSecurityMgrSite', 'DISPID_SPEEngineConfidence',
    'DISPID_SpeechLexiconProns', 'SpeechAudioFormatGUIDText',
    'DISPID_SGRSTransitions', 'DISPID_SRGCmdSetRuleIdState',
    'SpeechDataKeyLocation', 'SpNotifyTranslator',
    'DISPID_SPIAudioSizeBytes', 'SGSEnabled', 'SSFMCreate',
    'DISPID_SPRsItem', 'DISPID_SVSRunningState',
    'SAFT24kHz8BitStereo', 'SSSPTRelativeToCurrentPosition',
    'SpResourceManager', 'DISPID_SAStatus', 'SpObjectTokenCategory',
    'ISequentialStream', 'eLEXTYPE_PRIVATE9', 'SPGS_ENABLED',
    'SPPHRASEELEMENT', 'eLEXTYPE_RESERVED10',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SPPConfidence', 'SVP_15',
    'DISPID_SRGRecoContext', 'SGLexical', 'STSF_LocalAppData',
    'DISPID_SRRTTickCount', 'SpPhoneticAlphabetConverter',
    'DISPID_SRRDiscardResultInfo', 'SpeechSpecialTransitionType',
    'SVP_2', 'DISPID_SRGDictationUnload', 'SRAONone', 'SVP_16',
    'SpMMAudioIn', 'SPSERIALIZEDRESULT', 'DISPID_SVWaitUntilDone',
    'SAFT16kHz8BitStereo', 'DISPID_SPEAudioStreamOffset',
    'ISpeechPhraseInfoBuilder', 'SVSFNLPMask',
    'SpeechRecognizerState', 'DISPID_SpeechWaveFormatEx',
    'SPVPRIORITY', 'SGPronounciation', 'SPAUDIOBUFFERINFO',
    'DISPID_SVIsUISupported', 'SPWORDPRONUNCIATIONLIST',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SGRs_NewEnum',
    'DISPID_SOTDisplayUI', 'SpeechDiscardType', 'SPSLMA',
    'SpeechMicTraining', 'DISPID_SVEWord',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SCSBaseStream',
    'SpeechDisplayAttributes', 'SVEEndInputStream',
    'DISPID_SLPPhoneIds', 'Speech_StreamPos_Asap', 'SP_VISEME_11',
    'SREStreamEnd', 'SAFTCCITT_ALaw_44kHzMono', 'SRERequestUI',
    'ISpeechWaveFormatEx', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SGRSAddSpecialTransition', 'ISpRecognizer',
    'SAFT12kHz16BitStereo', 'ISpMMSysAudio', 'SREFalseRecognition',
    'DISPID_SFSOpen', 'DISPID_SRGState',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SVEEnginePrivate', 'SpMMAudioOut', 'SVSFParseAutodetect',
    'SpeechEmulationCompareFlags', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SRSCurrentStreamPosition', 'SSSPTRelativeToEnd',
    'SpeechCategoryRecoProfiles', 'SPPROPERTYINFO', 'DISPID_SFSClose',
    'DISPID_SPRuleId', 'DISPID_SAEventHandle',
    'DISPID_SRCCreateGrammar', 'SVP_6', 'DISPID_SPIReplacements',
    'DISPID_SVSInputSentenceLength', 'DISPID_SOTsItem',
    'SREStateChange', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SAFT8kHz8BitMono', 'ISpeechRecoResultDispatch', 'SPAR_Low',
    'DISPID_SDKEnumValues', 'DISPID_SDKDeleteKey',
    'ISpeechRecoContext', 'STCAll', 'SRAExport',
    'DISPID_SRCRequestedUIType', 'DISPID_SGRSAddWordTransition',
    'SpVoice', 'SAFT48kHz16BitStereo', 'SAFTCCITT_uLaw_44kHzMono',
    'SSFMCreateForWrite', 'SPGS_EXCLUSIVE', 'SpStream',
    'ISpPhraseAlt', 'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SGRId',
    'SPSEMANTICFORMAT', 'DISPID_SVPause', 'SSSPTRelativeToStart',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SGRSTType',
    'ISpObjectWithToken', 'IEnumSpObjectTokens', 'DISPID_SLWType',
    'DISPID_SBSRead', 'DISPID_SpeechVoiceStatus', 'DISPID_SGRSTRule',
    'DISPIDSPTSI_SelectionLength', 'SVEBookmark',
    'DISPID_SRRSetTextFeedback', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SASState', 'DISPID_SpeechGrammarRuleStateTransitions',
    'eLEXTYPE_PRIVATE7', 'ISpResourceManager', 'eLEXTYPE_PRIVATE19',
    'SINone', 'DISPID_SpeechPhraseRule', 'SPPS_Verb',
    'ISpeechPhraseReplacement', 'SRSEDone',
    'DISPID_SPERequiredConfidence', 'SREAudioLevel', 'DISPID_SOTCId'
]
